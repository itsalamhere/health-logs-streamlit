...
#     ... # Make an explanation of the web-app. Short.
...
if selected_player == 'all':
    ...
    with st.sidebar.expander('Data Logs'):
        missing_files = st.markdown(missing_file_lists)
    ...
    ### FEATURES IN MAIN BAR
    with st.container(height=90):
        st.write(
            "The charts below are modifiable with each respective parameters.  \n",
            "You can adjust the parameters on the sidebar.  \n")
